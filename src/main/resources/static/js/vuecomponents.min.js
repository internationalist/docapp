Vue.component("dynamicnav",{template:`<div><nav id="fixednav" class="navbar navbar-dark navbar-expand-sm navstyle fixednav">
			...
			</nav></div>`,data:vueNav,methods:{choose:function(a){for(let b=0;b<this.menu.length;b++)this.menu[b].selected=!1;let b=matchArrayOnValue(this.menu,"name",a);this.menu[b].selected=!0}}}),Vue.component("footermodule",{template:`
